...
def main(args):
    ...
    for _ in range(args.max_round):   
        ...
        log(args, f"[Round {_}] [Timing] Observation retrieval took {obs_time:.4f} seconds.\n", "green")
        ...
        log(args, f"[Round {_}] [Timing] Agent decision took {agent_time:.4f} seconds.\n", "green")
        ...
        log(args, f"[Round {_}] [Timing] Environment step execution took {env_step_time:.4f} seconds.\n", "green")
