...
def _start_worker(name, port, controller, definition):
    ...
    # print("conf: ", conf) conf:  {'module': 'src.server.tasks.omnigibson.OmniGibson', 'parameters': {'name': 'OmniGibson', 'max_round': 100, 'available_ports': [12000, 12001, 12002], 'available_devices': {'0': 3}, 'data_dir': 'data/omnigibson', 'output_dir': 'outputs/omnigibson', 'docker_image': 'tianjiezhang/vab_omnigibson:latest'}}
    # assert 1==0
    if "docker" in conf and "image" in conf["docker"]:
        ...
        # print("Here:", name, port, controller)
        # assert 1==0
#         Here: omnigibson 5001 http://localhost:5000/api
# Here: omnigibson 5002 http://localhost:5000/api
# Here: omnigibson 5003 http://localhost:5000/api
...
if __name__ == "__main__":
    ...
    if args.controller:
        print("config: ", config)
#         config:  {'definition': {'omnigibson': {'module': 'src.server.tasks.omnigibson.OmniGibson', 'parameters': {'name': 'OmniGibson',
#  'max_round': 100, 'available_ports': [12000, 12001, 12002], 'available_devices': {'0': 3}, 'data_dir': 'data/omnigibson', 'outp
# ut_dir': 'outputs/omnigibson', 'docker_image': 'tianjiezhang/vab_omnigibson:latest'}}}, 'start': {'omnigibson': 3}}
    ...
    base_port = args.port
    # print("args.controller_addr: ", args.controller_addr) ""
    # assert 1==0
    ...
    # print("controller_addr: ", controller_addr)
    # controller_addr:  http://localhost:5000/api
    # assert 1==0
